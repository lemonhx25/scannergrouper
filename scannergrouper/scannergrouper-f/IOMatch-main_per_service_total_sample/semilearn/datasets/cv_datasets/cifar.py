...
class CIFAR10():
    ...
    def __init__(
        ...
        self.train_list = [
        ["data_"+self.dataset+'_'+'train'+'_'+self.service+".pkl", ""],
# =============================================================================
...
# =============================================================================
        ...
        self.test_list = [
            ["data_"+self.dataset+'_'+'test'+'_'+self.service+".pkl", ""],
        ]
...
def get_cifar_openset(args, alg, name, num_labels, num_classes, data_dir='./data', pure_unlabeled=False):
    ...
    dset= CIFAR10(data_dir,dataset=dataset_name,service=service,shape=shape,train=True)
    ...
    dset= CIFAR10(data_dir,dataset=dataset_name,service=service,shape=shape, train=False)
