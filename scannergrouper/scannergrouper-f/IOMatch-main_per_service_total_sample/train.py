...
def get_config():
    ...
    parser.add_argument('-nl', '--num_labels', type=int, default=80)#250
    ...
    #parser.add_argument('--img_size', type=str, default=16)
    def parse_list(arg):
        return list(map(int, arg.split(',')))

    parser.add_argument('--img_size', type=parse_list, help='Image size as a list of integers (e.g., "128,128")')
